...
Forks also power Vial's Key Override feature: entries edited in the Key Override tab use the same fork slots, take effect immediately, and persist to flash.
